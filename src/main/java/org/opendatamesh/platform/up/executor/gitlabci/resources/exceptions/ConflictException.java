 ...
 */
public class ConflictException extends ODMApiException {

    public ConflictException(ODMApiStandardErrors error, String message) {
		super(error, message);
	}
	...
	public ConflictException(ODMApiStandardErrors error, String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
		super(error, message, cause, enableSuppression, writableStackTrace);
	}


	public ConflictException(ODMApiStandardErrors error, String message, Throwable cause) {
