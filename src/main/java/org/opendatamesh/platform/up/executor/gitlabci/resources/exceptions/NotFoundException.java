 ...
 */
public class NotFoundException extends ODMApiException {

	public NotFoundException(ODMApiStandardErrors error, String message) {
		super(error, message);
	}
	...
	public NotFoundException(ODMApiStandardErrors error, String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
		super(error, message, cause, enableSuppression, writableStackTrace);
	}


	public NotFoundException(ODMApiStandardErrors error, String message, Throwable cause) {
