 ...
 */
public class UnprocessableEntityException extends ODMApiException {

	public UnprocessableEntityException(ODMApiStandardErrors error, String message) {
		super(error, message);
	}
	...
	public UnprocessableEntityException(ODMApiStandardErrors error, String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
		super(error, message, cause, enableSuppression, writableStackTrace);
	}


	public UnprocessableEntityException(ODMApiStandardErrors error, String message, Throwable cause) {
